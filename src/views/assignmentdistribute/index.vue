...
import { getHomeworkUrl, downloadHomeworkUrl } from "../../util/api.js";
export default {
  mounted() {
    this.getFileList();
  },
  ...
  methods: {
    handleClick(file) {
      ...
      this._ajax("post", downloadHomeworkUrl, data, {}, callback, error, exception, "application/x-www-form-urlencoded",
        'blob');
    },
    getFileList() {
      let loading = Loading.service({
